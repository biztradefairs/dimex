      ...
      <SectionContainer>
        <div className="flex flex-col gap-8">
          ...
          <a href="/explore-pune" className="mt-6 w-fit">
            <button className="flex items-center justify-center gap-2 rounded-full bg-[#004A96] px-8 lg:px-10 py-3 lg:py-4 text-[16px] font-semibold text-white transition-all duration-300 hover:bg-[#E0161D]">
              City Guide
            </button>
          </a>
