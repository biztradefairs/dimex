      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#004A96] hover:bg-[#003875] text-white font-semibold py-3 px-8 rounded-full transition-colors duration-300"
          >
            {buttonText}
        ...
        <div className="relative">
          <div className="aspect-square bg-gradient-to-br from-[#E8F1F8] to-[#D6E6F4] rounded-2xl overflow-hidden shadow-xl">
            <div className="absolute inset-0 flex items-center justify-center p-8">
              <div className="text-center">
                <div className="w-32 h-32 mx-auto mb-6 bg-white rounded-full flex items-center justify-center shadow-lg">
                  <svg className="w-16 h-16 text-[#004A96]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
