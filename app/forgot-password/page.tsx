      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-[#D6E6F4]">
            <EnvelopeIcon className="h-6 w-6 text-[#004A96]" />
          </div>
        ...
        <div className="bg-white py-8 px-6 shadow-xl rounded-2xl sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[#004A96] focus:border-[#004A96] sm:text-sm"
            ...
            <div className="text-center">
              <Link
                href="/login"
                className="font-medium text-[#004A96] hover:text-[#004A96] text-sm"
              >
                ← Back to login
              </Link>
            </div>
